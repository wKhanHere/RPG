...
class LivingEntity:
    def __init__(self):
        ...
        self.RangedAtk:float = 1 #Base 1, Affected also by Throwing Power -> Essential use multiple turns to deal more damage #Think Imbibitor Lunae (Dan Heng)
    ...
    def CreateGenericEntity(
        ...
        #For loot tables, there will be no parameters here, it will be managed individually by each entity class, maybe even a loottable builder class.
